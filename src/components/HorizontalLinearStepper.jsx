...
const steps = ['Select a template', 'Enter Your Details', 'Preview Resume'];
const initialSate = {
  name: {
    firstname: '',
    lastname: ''
...
export default function HorizontalLinearStepper() {
  ...
  const [selectedResume,
    setSelectedResume] = React.useState();
  const [userInfo,
    setUserinfo] = useState(initialSate);
  ...
  const handleNext = () => {
    if (!selectedResume) 
      return alert('Please Select a Template to Proceed.')
          ...
          <React.Fragment>
            <Typography sx={{
              ...
              mb: 1
                ...
                ? <SelectResume setSelectedResume={setSelectedResume}/>
                : activeStep == 1
